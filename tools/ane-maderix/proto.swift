...
/// int32 scalar immediate Value (for constexpr axis attribute).
func intScalarValue(_ v: Int) -> Data {
    let tv = lenF(2, lenF(1, varint(UInt64(bitPattern: Int64(v)))))
    return lenF(2, valueType(.int32, [])) + lenF(3, lenF(1, tv))
}
