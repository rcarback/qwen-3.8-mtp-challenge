...
// (retry marker: first ticket 4c21f521 died pre-measurement to the runner's
// quiescence gate, FATAL(code=3) load 2.01 >= 2.0 -- identical content
// otherwise; the byte difference exists only for archive identity.)
//
